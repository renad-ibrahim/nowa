                            ...
                            <div class="col-8">
                                <div class="ps-4 pt-4 pe-3 pb-4 pt-0">
                                    ...
                                    <div class="pb-0 mt-0">
                                        ...
                                        <p class="mb-0 tx-12 text-muted">Last week<i class="fas fa-arrow-circle-up ms-2 text-success"></i>
                            ...
                            <div class="col-8">
                                <div class="ps-4 pt-4 pe-3 pb-4 pt-0">
                                    ...
                                    <div class="pb-0 mt-0">
                                        ...
                                        <p class="mb-0 tx-12 text-muted">Last week<i class="fas fa-arrow-circle-down ms-2 text-danger"></i>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-xl-4 col-lg-12">
                    <div class="card user-wideget user-wideget-widget widget-user">
                        ...
                        <div class="widget-user-image">
                            <img src="{{url('assets/img/faces/17.jpg')}}" class="brround" alt="User Avatar">
                        </div>
                ...
                <div class="col-sm-12 col-xl-4 col-lg-12">
                    <div class="card user-wideget user-wideget-widget widget-user">
                        ...
                        <div class="widget-user-image">
                            <img src="{{url('assets/img/faces/12.jpg')}}" class="brround" alt="User Avatar">
                        </div>
                        <div class="user-wideget-footer">
                            <div class="row">
                                <div class="col-sm-4 border-end">
                ...
                <div class="col-sm-12 col-xl-4 col-lg-12">
                    <div class="card user-wideget user-wideget-widget widget-user">
                        ...
                        <div class="widget-user-image">
                            <img src="{{url('assets/img/faces/5.jpg')}}" class="brround" alt="User Avatar">
                        </div>
                        <div class="user-wideget-footer">
                            <div class="row">
                                <div class="col-sm-4 border-end">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="list d-flex align-items-center border-bottom py-3">
                                <div class="avatar brround d-block cover-image" data-image-src="{{url('assets/img/faces/5.jpg')}}">
                            ...
                            <div class="list d-flex align-items-center border-bottom py-3">
                                <div class="avatar brround d-block cover-image" data-image-src="{{url('assets/img/faces/1.jpg')}}">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                                <div class="wrapper w-100 ms-3">
                                    <p class="mb-0">
                            ...
                            <div class="list d-flex align-items-center border-bottom py-3">
                                <div class="avatar brround d-block cover-image" data-image-src="{{url('assets/img/faces/14.jpg')}}">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                                <div class="wrapper w-100 ms-3">
                                    <p class="mb-0">
                            ...
                            <div class="list d-flex align-items-center pt-3">
                                <div class="avatar brround d-block cover-image" data-image-src="{{url('assets/img/faces/4.jpg')}}">
                                    <span class="avatar-status bg-green"></span>
                                </div>
                                <div class="wrapper w-100 ms-3">
                                    <p class="mb-0">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pd-y-7">
                            ...
                            <div class="wrapper d-flex justify-content-center image-group pb-3">
                                <img src="{{url('assets/img/faces/1.jpg')}}" alt="profile" class="img-xs rounded-circle">
                                <img src="{{url('assets/img/faces/2.jpg')}}" alt="profile" class="img-xs rounded-circle">
                                <img src="{{url('assets/img/faces/13.jpg')}}" alt="profile" class="img-xs rounded-circle">
                                <img src="{{url('assets/img/faces/14.jpg')}}" alt="profile" class="img-xs rounded-circle">
                                <img src="{{url('assets/img/faces/5.jpg')}}" alt="profile" class="img-xs rounded-circle">
                                <img src="{{url('assets/img/faces/16.jpg')}}" alt="profile" class="img-xs rounded-circle">
                            </div>
                        </div><!-- card-body -->
                    </div>
                </div>
                    ...
                    <div class="card order-list">
                        <div class="card-body">
                            ...
                            <ul class="list list-noborders pb-0 mb-0">
                                <li class="list-item">
                                    <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{url('assets/img/faces/3.jpg')}}" alt="Profile Image">
                                    <div class=" ms-3">
                                        <h6 class="mb-1 font-weight-medium">Lottie Arnold</h6>
                                        <p class="mb-0 text-muted tx-13">#PRD-10250</p>
                                    </div>
                                    <div class="ms-auto d-flex">
                                        <img class="img-sm me-1" src="{{url('assets/img/ecommerce/03.jpg')}}" alt="thumb images">
                                        <img class="img-sm" src="{{url('assets/img/ecommerce/08.jpg')}}" alt="thumb images">
                                    </div>
                                </li>
                                <li class="list-item">
                                    <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{url('assets/img/faces/9.jpg')}}" alt="Profile Image">
                                    <div class=" ms-3">
                                        <h6 class="mb-1 font-weight-medium">Alan Macedo</h6>
                                        <p class="mb-0 tx-13 text-muted">#PRD-10251</p>
                                    </div>
                                    <div class="ms-auto d-flex">
                                        <img class="img-sm me-1" src="{{url('assets/img/ecommerce/04.jpg')}}" alt="thumb images">
                                        <img class="img-sm" src="{{url('assets/img/ecommerce/05.jpg')}}" alt="thumb images">
                                    </div>
                                </li>
                                <li class="list-item">
                                    <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{url('assets/img/faces/5.jpg')}}" alt="Profile Image">
                                    <div class=" ms-3">
                                        <h6 class="mb-1 font-weight-medium">Bruce Tran</h6>
                                        <p class="mb-0 text-muted tx-13">#PRD-10252</p>
                                    </div>
                                    <div class="ms-auto d-flex">
                                        <img class="img-sm me-1" src="{{url('assets/img/ecommerce/06.jpg')}}" alt="thumb images">
                                        <img class="img-sm" src="{{url('assets/img/ecommerce/07.jpg')}}" alt="thumb images">
                                    </div>
                                </li>
                                <li class="list-item">
                                    <img class="img-sm rounded-circle bg-warning d-flex align-items-center justify-content-center text-white" src="{{url('assets/img/faces/12.jpg')}}" alt="Profile Image">
                                    <div class=" ms-3">
                                        <h6 class="mb-1 font-weight-medium">Mina Harper</h6>
                                        <p class="mb-0 text-muted tx-13">#PRD-10253</p>
                                    </div>
                                    <div class="ms-auto d-flex">
                                        <img class="img-sm me-1" src="{{url('assets/img/ecommerce/08.jpg')}}" alt="thumb images">
                                        <img class="img-sm" src="{{url('assets/img/ecommerce/09.jpg')}}" alt="thumb images">
                                    </div>
                                </li>
                        </ul>
                        </div>
                        ...
                        <div class="rating-scroll ps ps--active-y">
                                ...
                                <div class="media mt-0">
                                    <div class="d-flex me-3">
                                        <a href="javascript:void(0);">
                                            <img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{url('assets/img/faces/5.jpg')}}">
                                        </a>
                                    </div>
                            ...
                            <div class="ps-3 pe-3 py-3 border-bottom">
                                <div class="media mt-0">
                                    <div class="d-flex me-3">
                                        <a href="javascript:void(0);">
                                            <img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{url('assets/img/faces/9.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="d-flex">
                            ...
                            <div class="ps-3 pe-3 py-3 border-bottom">
                                <div class="media mt-0">
                                    <div class="d-flex me-3">
                                        <a href="javascript:void(0);">
                                            <img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{url('assets/img/faces/4.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="d-flex">
                            ...
                            <div class="ps-3 pe-3 py-3 border-bottom">
                                <div class="media mt-0">
                                    <div class="d-flex me-3">
                                        <a href="javascript:void(0);">
                                            <img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{url('assets/img/faces/7.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="d-flex">
                            ...
                            <div class="ps-3 pe-3 py-3 border-bottom">
                                <div class="media mt-0">
                                    <div class="d-flex me-3">
                                        <a href="javascript:void(0);">
                                            <img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{url('assets/img/faces/12.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="d-flex">
                            ...
                            <div class="ps-3 pe-3 py-3 border-bottom">
                                <div class="media mt-0">
                                    <div class="d-flex me-3">
                                        <a href="javascript:void(0);">
                                            <img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{url('assets/img/faces/13.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="d-flex">
                            ...
                            <div class="ps-3 pe-3 py-3 border-bottom">
                                <div class="media mt-0">
                                    <div class="d-flex me-3">
                                        <a href="javascript:void(0);">
                                            <img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{url('assets/img/faces/2.jpg')}}">
                                        </a>
                                    </div>
                                    <div class="media-body">
                                        <div class="d-flex">
                        ...
                        <div class="card-body p-0">
                            <div class="browser-stats">
                                <div class="d-flex align-items-center item  border-bottom">
                                    <div class="d-flex">
                                        <img src="{{url('assets/img/svgicons/chrome.svg')}}" alt="img" class="ht-30 wd-30 me-2">
                                        <div class="">
                                            <h6 class="">Chrome</h6>
                                ...
                                <div class="d-flex align-items-center item  border-bottom">
                                    <div class="d-flex">
                                        <img src="{{url('assets/img/svgicons/opera.svg')}}" alt="img" class="ht-30 wd-30 me-2">
                                        <div class="">
                                            <h6 class="">Opera</h6>
                                            <span class="sub-text">Mozilla Foundation, Inc.</span>
                                        </div>
                                ...
                                <div class="d-flex align-items-center item  border-bottom">
                                    <div class="d-flex">
                                        <img src="{{url('assets/img/svgicons/edge.svg')}}" alt="img" class="ht-30 wd-30 me-2">
                                        <div class="">
                                            <h6 class="">Edge</h6>
                                            <span class="sub-text">Mozilla Foundation, Inc.</span>
                                        </div>
                                ...
                                <div class="d-flex align-items-center item  border-bottom">
                                    <div class="d-flex">
                                        <img src="{{url('assets/img/svgicons/firefox.svg')}}" alt="img" class="ht-30 wd-30 me-2">
                                        <div class="">
                                            <h6 class="">Firefox</h6>
                                            <span class="sub-text">Mozilla Foundation, Inc.</span>
                                        </div>
                                ...
                                <div class="d-flex align-items-center item border-bottom">
                                    <div class="d-flex">
                                        <img src="{{url('assets/img/svgicons/uc-browser.svg')}}" alt="img" class="ht-30 wd-30 me-2">
                                        <div class="">
                                ...
                                <div class="d-flex align-items-center item">
                                    <div class="d-flex">
                                        <img src="{{url('assets/img/svgicons/safari.svg')}}" alt="img" class="ht-30 wd-30 me-2">
                                        <div class="">
                                            <h6 class="">Safari</h6>
                                            <span class="sub-text">Mozilla Foundation, Inc.</span>
                                        </div>
