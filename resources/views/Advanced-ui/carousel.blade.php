										...
										<div class="carousel slide" data-bs-ride="carousel" id="carouselExampleSlidesOnly">
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/8.jpg')}}">
												</div>
												<div class="carousel-item">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/9.jpg')}}">
												</div>
												<div class="carousel-item">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/10.jpg')}}">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card-body ht-100p">
									...
									<div>
										<div class="carousel slide" data-bs-ride="carousel" id="carouselExample2">
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/18.jpg')}}">
												</div>
												<div class="carousel-item">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/12.jpg')}}">
												</div>
												<div class="carousel-item">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/13.jpg')}}">
												</div>
											</div>
								...
								<div class="card-body ht-100p">
									...
									<div>
										<div class="carousel slide" data-bs-ride="carousel" id="carouselExample3">
											...
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/14.jpg')}}">
												</div>
												<div class="carousel-item">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/15.jpg')}}">
												</div>
												<div class="carousel-item">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/16.jpg')}}">
												</div>
											</div>
										</div>
									</div>
									...
									<div>
										<div class="carousel slide" data-bs-ride="carousel" id="carouselExample4">
											...
											<div class="carousel-inner bg-dark">
												<div class="carousel-item active">
													<img alt="img" class="d-block w-100 op-3" src="{{url('assets/img/photos/17.jpg')}}">
												...
												<div class="carousel-item">
													<img alt="img" class="d-block w-100 op-3" src="{{url('assets/img/photos/18.jpg')}}">
													<div class="carousel-caption d-none d-md-block">
														<h5>Second Slide</h5>
														<p class="tx-14">Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
													</div>
												...
												<div class="carousel-item">
													<img alt="img" class="d-block w-100 op-3" src="{{url('assets/img/photos/19.jpg')}}">
													<div class="carousel-caption d-none d-md-block">
														<h5>Third Slide</h5>
														<p class="tx-14">Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
													</div>
								...
								<div class="card-body ht-100p">
									...
									<div>
										<div class="carousel slide carousel-fade" data-bs-ride="carousel" id="carouselExample5">
											...
											<div class="carousel-inner">
												<div class="carousel-item active">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/4.jpg')}}">
												</div>
												<div class="carousel-item">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/1.jpg')}}">
												</div>
												<div class="carousel-item ">
													<img alt="img" class="d-block w-100" src="{{url('assets/img/photos/2.jpg')}}">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card-body ht-100p">
									...
									<div id="basicSlider">
										<div class="MS-content">
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/1.jpg')}}" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/2.jpg')}}" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/3.jpg')}}" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/4.jpg')}}" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/5.jpg')}}" alt=""   class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/6.jpg')}}" alt=""   class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/7.jpg')}}" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/8.jpg')}}" alt="" class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/9.jpg')}}" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/10.jpg')}}" alt=""  class="br-5"> </a>
											</div>
											<div class="item">
												<a href="javascript:void(0);"> <img src="{{url('assets/img/photos/5.jpg')}}" alt=""  class="br-5"> </a>
											</div>
