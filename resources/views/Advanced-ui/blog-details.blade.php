							...
							<div class="col-xl-9 col-lg-9 col-md-12">
								<div class="card overflow-hidden">
									<div class="item7-card-img px-4 pt-4">
										...
										<img src="{{url('assets/img/photos/blog.jpg')}}" alt="img" class="cover-image br-7 w-100">
									</div>
									<div class="card-body">
									...
									<div class="card-footer pb-2 pt-2">
										<div class="item7-card-desc d-md-flex">
											<div class="d-flex align-items-center mt-0">
												<img src="{{url('assets/img/faces/2.jpg')}}" class="avatar brround avatar-md me-3" alt="avatar-img">
												<div>
													<a href="profile.html" class="text-default font-weight-bold">Lilly Potter</a>
										...
										<div class="card-body">
											<div class="d-sm-flex mt-0 p-3 sub-review-section border border-bottom-0 br-bl-0 br-br-0">
												<div class="d-flex me-3">
													<a href="javascript:void(0);"><img class="media-object brround avatar-md" alt="64x64" src="{{url('assets/img/faces/1.jpg')}}"> </a>
												</div>
											...
											<div class="d-sm-flex p-3 sub-review-section border subsection-color br-tl-0 br-tr-0">
												<div class="d-flex me-3">
													<a href="javascript:void(0);"><img class="media-object brround avatar-md" alt="64x64" src="{{url('assets/img/faces/3.jpg')}}"> </a>
												</div>
												<div class="media-body">
											...
											<div class="d-sm-flex p-3 mt-4 border sub-review-section pb-0">
												<div class="d-flex me-3">
													<a href="javascript:void(0);"><img class="media-object brround avatar-md" alt="64x64" src="{{url('assets/img/faces/5.jpg')}}"> </a>
												</div>
												<div class="media-body">
											...
											<div class="d-sm-flex p-3 sub-review-section border subsection-color br-tl-0 br-tr-0">
												<div class="d-flex me-3">
													<a href="javascript:void(0);"><img class="media-object brround avatar-md" alt="64x64" src="{{url('assets/img/faces/6.jpg')}}"> </a>
												</div>
												<div class="media-body">
