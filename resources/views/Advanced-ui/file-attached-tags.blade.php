				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">FILE ATTACHED</span>
						</div>
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								<li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Advanced UI</a></li>
								<li class="breadcrumb-item active" aria-current="page">File-attached</li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
                                    ...
                                    <div class="h-100  attached-file-grid6">
                                        <div class="pro-img-box attached-file-image">
                                            <a href="javascript:void(0);">
                                                <img class=" pic-1 pos-relative rounded-5" src="{{url('assets/img/media/1.jpg')}}" alt="attached-file-image"><span class="image-pic">123image.jpg</span>
                                            </a>
                                            <ul class="icons">
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="h-100  attached-file-grid6">
                                        <div class="pro-img-box attached-file-image">
                                            <a href="javascript:void(0);">
                                                <img class=" pic-1 pos-relative rounded-5" src="{{url('assets/img/media/2.jpg')}}" alt="attached-file-image"><span class="image-pic">123image.jpg</span>
                                            </a>
                                            <ul class="icons">
                                                <li class="me-1"><a href="javascript:void(0);" data-placement="top" data-bs-toggle="tooltip" title="download"><i class="fe fe-download"></i></a></li>
                                                <li class="me-1"><a href="javascript:void(0);" data-placement="top" data-bs-toggle="tooltip" title="delete"><i class="fe fe-trash"></i></a></li>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="h-100  attached-file-grid6">
                                        <div class="pro-img-box attached-file-image">
                                            <a href="javascript:void(0);">
                                                <img class=" pic-1 pos-relative rounded-5" src="{{url('assets/img/media/3.jpg')}}" alt="attached-file-image"><span class="image-pic">123image.jpg</span>
                                            </a>
                                            <ul class="icons">
                                                <li class="me-1"><a href="javascript:void(0);" data-placement="top" data-bs-toggle="tooltip" title="download"><i class="fe fe-download"></i></a></li>
                                                <li class="me-1"><a href="javascript:void(0);" data-placement="top" data-bs-toggle="tooltip" title="delete"><i class="fe fe-trash"></i></a></li>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    ...
                                    <div class="h-100  attached-file-grid6">
                                        <div class="pro-img-box attached-file-image">
                                            <a href="javascript:void(0);">
                                                <img class=" pic-1 pos-relative rounded-5" src="{{url('assets/img/media/4.jpg')}}" alt="attached-file-image"><span class="image-pic">123image.jpg</span>
                                            </a>
                                            <ul class="icons">
                                                <li class="me-1"><a href="javascript:void(0);" data-placement="top" data-bs-toggle="tooltip" title="download"><i class="fe fe-download"></i></a></li>
                                                <li class="me-1"><a href="javascript:void(0);" data-placement="top" data-bs-toggle="tooltip" title="delete"><i class="fe fe-trash"></i></a></li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="text-wrap pb-3">
                                        <div class="file-image-1">
                                            <div class="product-image">
                                                <a href="file-details.html">
                                                    <img src="{{url('assets/img/files/image.png')}}" class="br-5" alt="">
                                                </a>
                                                <ul class="icons">
                                        ...
                                        <div class="file-image-1">
                                            <div class="product-image">
                                                <a href="file-details.html"><img src="{{url('assets/img/files/doc.png')}}" alt=""></a>
                                                <ul class="icons">
                                                    <li><a href="javascript:void(0);" class="bg-danger"><i class="fe fe-trash"></i></a></li>
                                                    <li><a href="javascript:void(0);" class="bg-secondary"><i class="fe fe-download"></i></a></li>
                                                    <li><a href="javascript:void(0);" class="bg-primary"><i class="fe fe-eye"></i></a></li>
                                        ...
                                        <div class="file-image-1">
                                            <div class="product-image">
                                                <a href="file-details.html"><img src="{{url('assets/img/files/file2.png')}}" alt=""></a>
                                                <ul class="icons">
                                                    <li><a href="javascript:void(0);" class="bg-danger"><i class="fe fe-trash"></i></a></li>
                                                    <li><a href="javascript:void(0);" class="bg-secondary"><i class="fe fe-download"></i></a></li>
                                                    <li><a href="javascript:void(0);" class="bg-primary"><i class="fe fe-eye"></i></a></li>
                                        ...
                                        <div class="file-image-1">
                                            <div class="product-image">
                                                <a href="file-details.html"><img src="{{url('assets/img/files/file.png')}}" alt=""></a>
                                                <ul class="icons">
                                                    <li><a href="javascript:void(0);" class="bg-danger"><i class="fe fe-trash"></i></a></li>
                                                    <li><a href="javascript:void(0);" class="bg-secondary"><i class="fe fe-download"></i></a></li>
                                                    <li><a href="javascript:void(0);" class="bg-primary"><i class="fe fe-eye"></i></a></li>
                                        ...
                                        <div class="file-image-1">
                                            <div class="product-image">
                                                <a href="file-details.html">
                                                    <img src="{{url('assets/img/media/climate.jpg')}}" class="br-5" alt="">
                                                </a>
                                                <ul class="icons">
                                                    <li><a href="javascript:void(0);" class="bg-danger"><i class="fe fe-trash"></i></a></li>
                                                    <li><a href="javascript:void(0);" class="bg-secondary"><i class="fe fe-download"></i></a></li>
