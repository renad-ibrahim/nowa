				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">COUNTRES</span>
						</div>
						<div class="justify-content-center mt-2">
							<ol class="breadcrumb">
								<li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Advanced UI</a></li>
								<li class="breadcrumb-item active" aria-current="page">Countres</li>
							</ol>
						</div>
					</div>
					<!-- /breadcrumb -->
						...
						<div class="col-sm-12 col-md-12 col-xl-4">
							<div class="card custom-card">
								<div class="card-body text-center card-img-top-1">
									...
									<img src="{{url('assets/img/media/illustrate.png')}}" alt="counter-image" class="wd-300 ht-300 ">
						...
						<div class="col-sm-12 col-md-12 col-xl-4">
							<div class="card custom-card">
								<div class="card-body text-center card-img-top-1">
									...
									<img src="{{url('assets/img/media/illustrate1.png')}}" alt="counter-image" class="wd-300 ht-300 ">
						...
						<div class="col-sm-12 col-md-12 col-xl-4">
							<div class="card custom-card">
								<div class="card-body text-center card-img-top-1 ">
									...
									<img src="{{url('assets/img/media/illustrate2.png')}}" alt="counter-image" class="wd-300 ht-300 ">
