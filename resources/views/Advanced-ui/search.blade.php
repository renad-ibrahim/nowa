											...
											<div class="col-sm-6 col-lg-3">
												<a class="" href="javascript:void(0);">
													<div class="border  br-5 p-0 text-center m-1">
														<img src="{{url('assets/img/photos/1.jpg')}}" alt="img" class="mx-auto br-5">
													</div>
												</a>
											</div>
											<div class="col-sm-6 col-lg-3">
												<a class="" href="javascript:void(0);">
													<div class="border   br-5 p-0 text-center m-1">
														<img src="{{url('assets/img/photos/3.jpg')}}" alt="img" class="mx-auto  br-5">
													</div>
												</a>
											</div>
											<div class="col-sm-6 col-lg-3">
												<a class="" href="javascript:void(0);">
													<div class="border br-5 p-0 text-center m-1">
														<img src="{{url('assets/img/photos/5.jpg')}}" alt="img" class="mx-auto  br-5">
													</div>
												</a>
											</div>
											<div class="col-sm-6 col-lg-3">
												<a class="" href="javascript:void(0);">
													<div class="border br-5 p-0 text-center m-1">
														<img src="{{url('assets/img/photos/6.jpg')}}" alt="img" class="mx-auto  br-5">
													</div>
												</a>
											</div>
										</div>
