			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
						...
						<div class="row row-deck">
							<div class="col-xl-6 col-lg-6	 col-md-12">
								<div class="card overflow-hidden">
									<a href="blog-details.html" class="card custom-card card-img-top-1 background-image-blog mb-0">
									</a>
									...
									<div class="card-footer">
										<div class="item7-card-desc d-md-flex mt-0">
							...
							<div class="col-xl-3 col-lg-6  col-sm-6">
								<div class="card custom-card card-img-top-1">
									<a href="blog-details.html"><img class="card-img-top w-100 w-100" src="{{url('assets/img/photos/11.jpg')}}" alt=""></a>
									<div class="card-body pb-0">
										<a href="blog-details.html"><h4 class="card-title">10 Ways To Immediately Start Selling Products !</h4></a>
									...
									<div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
										...
										<img alt="avatar" src="{{url('assets/img/faces/9.jpg')}}">
										</div>
											...
											<div class="item-list">
												<ul class="list-group mb-0">
													<li class="list-group-item d-flex border-bottom-0 pt-4">
														<img src="{{url('assets/img/photos/blog1.jpg')}}" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
														<div class="">
													...
													<li class="list-group-item d-flex border-bottom-0">
														<img src="{{url('assets/img/photos/blog2.jpg')}}" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
														<div class="">
													...
													<li class="list-group-item d-flex border-bottom-0">
														<img src="{{url('assets/img/photos/blog5.jpg')}}" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
														<div class="">
													...
													<li class="list-group-item d-flex border-bottom-0">
														<img src="{{url('assets/img/photos/blog4.jpg')}}" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
														<div class="">
													...
													<li class="list-group-item d-flex  pb-4 br-bs-7 br-be-7">
														<img src="{{url('assets/img/photos/blog6.jpg')}}" class="avatar br-5 avatar-lg me-3 my-auto" alt="avatar-img">
														<div class="">
					...
					<div class="row row-deck">
						<div class="col-xl-3 col-lg-6  col-sm-6">
							<div class="card custom-card card-img-top-1">
								<a href="blog-details.html"><img class="card-img-top w-100 w-100" src="{{url('assets/img/photos/2.jpg')}}" alt=""></a>
								<div class="card-body pb-0">
									<a href="blog-details.html"><h4 class="card-title">How To Become Better With Building In 1 Month !</h4></a>
								...
								<div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
									<div class="main-img-user online">
									<img alt="avatar" src="{{url('assets/img/faces/2.jpg')}}">
									</div>
									<div class="main-contact-body">
										<h6>Abigail John</h6>
									</div>
						...
						<div class="col-xl-3 col-lg-6  col-sm-6">
							<div class="card custom-card card-img-top-1">
								<a href="blog-details.html"><img class="card-img-top w-100 w-100" src="{{url('assets/img/photos/1.jpg')}}" alt=""></a>
								<div class="card-body pb-0">
									<a href="blog-details.html"><h4 class="card-title">10 Ways To Immediately Start Selling Products !</h4></a>
									<p class="card-text mb-2">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
									</div>
						...
						<div class="col-xl-3 col-lg-6  col-sm-6">
							<div class="card custom-card card-img-top-1">
								<a href="blog-details.html"><img class="card-img-top w-100 w-100" src="{{url('assets/img/photos/9.jpg')}}" alt=""></a>
								<div class="card-body pb-0">
									<a href="blog-details.html"><h4 class="card-title">3 Easy Ways To Make Your mobile Faster & Even !</h4></a>
									<p class="card-text mb-2">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
								</div>
								<div class="item7-card-desc d-flex p-3 pt-0 align-items-center justify-content-center border-top">
									<div class="main-img-user online">
									<img alt="avatar" src="{{url('assets/img/faces/7.jpg')}}">
									</div>
									<div class="main-contact-body">
										<h6>Raven Chanan</h6>
									</div>
								   ...
								   <a href="javascript:void(0);" class="border-0">
										<div class="list-group-item list-group-item-action">
											<div class="media mt-0">
												<img class="avatar-lg rounded-circle me-3 my-auto" src="{{url('assets/img/faces/3.jpg')}}" alt="Image description">
										 ...
										 <a href="javascript:void(0);" class="border-0">
											<div class="list-group-item list-group-item-action">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle me-3 my-auto" src="{{url('assets/img/faces/11.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-flex align-items-center">
															<div class="mt-1">
										...
										<a href="javascript:void(0);" class="border-0">
											<div class="list-group-item list-group-item-action">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle me-3 my-auto" src="{{url('assets/img/faces/17.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-flex align-items-center">
															<div class="mt-1">
										...
										<a href="javascript:void(0);" class="border-0">
											<div class="list-group-item list-group-item-action">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle me-3 my-auto" src="{{url('assets/img/faces/15.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-flex align-items-center">
															<div class="mt-1">
										...
										<a href="javascript:void(0);" class="border-0">
											<div class="list-group-item list-group-item-action">
												<div class="media mt-0">
													<img class="avatar-lg rounded-circle me-3 my-auto" src="{{url('assets/img/faces/13.jpg')}}" alt="Image description">
													<div class="media-body">
														<div class="d-flex align-items-center">
															<div class="mt-1">
																<h5 class="mb-1 tx-13 font-weight-sembold text-dark">Manuel Labor</h5>
