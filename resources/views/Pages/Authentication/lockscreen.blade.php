                    ...
                    <div class="col-xl-5 col-lg-6 col-md-8 col-sm-8 col-xs-10 card-sigin-main py-4 justify-content-center mx-auto">
                        <div class="card-sigin">
                             ...
                             <div class="main-card-signin d-md-flex">
                                 <div class="wd-100p">
                                     <div class="d-flex mx-auto"> <a href="index.html" class="mx-auto d-flex"><img src="{{url('assets/img/brand/favicon.png')}}" class="sign-favicon ht-40 mx-auto" alt="logo"><h1 class="main-logo1 ms-1 me-0 my-auto tx-28 text-dark ms-2">no<span>w</span>a</h1></a></div>
                                     <div class="main-card-signin d-md-flex bg-white">
                                         <div class="p-4 wd-100p">
                                             <div class="main-signin-header">
                                                 <div class="avatar avatar-xxl avatar-xxl mx-auto text-center mb-2"><img alt="" class="avatar avatar-xxl rounded-circle  mt-2 mb-2 " src="{{url('assets/img/faces/6.jpg')}}"></div>
