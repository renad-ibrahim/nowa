						...
						<div class="row row-sm">
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										<div class="d-lg-flex">
											<h6 class="main-content-label mb-1"><span class="d-flex mb-4"><a href="index.html"><img src="{{url('assets/img/brand/favicon.png')}}" class="sign-favicon ht-40" alt="logo"></a></span></h6>
												<div class="ms-auto">
