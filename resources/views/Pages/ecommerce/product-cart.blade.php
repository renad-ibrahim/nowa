				...
				<div class="main-container container-fluid">
					...
					<div class="breadcrumb-header justify-content-between">
						<div class="left-content">
						  <span class="main-content-title mg-b-0 mg-b-lg-1">PRODUCT CART</span>
						</div>
							...
							<div class="card">
											...
											<tbody>
													...
													<td>
														<div class="media">
															<div class="card-aside-img">
																<img src="{{url('assets/img/ecommerce/01.jpg')}}" alt="img" class="h-60 w-60">
															</div>
												...
												<tr>
													<td>
														<div class="media">
															<div class="card-aside-img">
																<img src="{{url('assets/img/ecommerce/09.jpg')}}" alt="img" class="h-60 w-60">
															</div>
															<div class="media-body">
																<div class="card-item-desc mt-0">
												...
												<tr>
													<td>
														<div class="media">
															<div class="card-aside-img">
																<img src="{{url('assets/img/ecommerce/08.jpg')}}" alt="img" class="h-60 w-60">
															</div>
															<div class="media-body">
																<div class="card-item-desc mt-0">
												...
												<tr>
													<td  class="">
														<div class="media">
															<div class="card-aside-img">
																<img src="{{url('assets/img/ecommerce/02.jpg')}}" alt="img" class="h-60 w-60">
															</div>
															<div class="media-body">
																<div class="card-item-desc mt-0">
								...
								<div class="card-footer">
									<div class="shopping-cart-footer bd-0">
										<div class="column"><a class="btn btn-secondary" href="shop.html"><i class="fe fe-corner-up-left  me-2"></i>Back to Shopping</a></div>
										<div class="column">
											<a class="btn btn-primary" href="product-cart.html"><i class="fe fe-refresh-cw me-2"></i>Update Cart</a>
											<a class="btn btn-outline-primary" href="check-out.html"><i class="fe fe-log-in me-2"></i>Checkout</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-12 col-xl-3 col-md-12">
								...
								<div class="card custom-card cart-details">
									<div class="card-body">
										...
										<div class="card-footer">
											<div class="column"><a class="btn btn-primary" href="shop.html">Continue Shopping</a></div>
										</div>
								</div>
							</div>
					</div>
