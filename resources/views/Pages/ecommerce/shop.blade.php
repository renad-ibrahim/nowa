										...
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
											   <a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/9.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/09.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/8.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/08.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/6.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/06.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/01.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/1.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/02.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/2.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/3.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/03.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/4.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/04.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist"><a href="wish-list.html" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
													<li><a href="product-details.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Quick View" class="info-gradient"><i class="fas fa-eye"></i></a></li>
											</ul>
											</div>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/5.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/05.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/7.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/07.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/11.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/10.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/13.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/12.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fa fa-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fa fa-shopping-cart"></i></a></li>
								...
								<div class="col-md-6 col-lg-6 col-xl-3  col-sm-6">
									<div class="card">
										<div class="card-body h-100  product-grid6">
											<div class="pro-img-box product-image">
												<a href="product-details.html">
													<img class=" pic-1" src="{{url('assets/img/ecommerce/14.jpg')}}" alt="product-image">
													<img class="pic-2" src="{{url('assets/img/ecommerce/15.jpg')}}" alt="product-image-1">
												</a>
												<ul class="icons">
													<li><a href="wish-list.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Wishlist" class="primary-gradient me-2"><i class="fe fe-heart"></i></a></li>
													<li><a href="product-cart.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Add to Cart" class="secondary-gradient me-2"><i class="fe fe-shopping-cart"></i></a></li>
													<li><a href="product-details.html" data-bs-placement="top" data-bs-toggle="tooltip" title="Quick View" class="info-gradient"><i class="fe fe-eye"></i></a></li>
											</ul>
											</div>
											<div class="text-center pt-2">
