								...
								<div class="row">
										...
										<div class="card item-card ">
											<div class="card-body pb-0">
												<div class="text-center zoom">
													<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/1.jpg")}}"  alt="img" ></a>
												</div>
											...
											<div class="card-footer text-center">
												<div class="text-center ps-2 pe-2">
													<a href="product-cart.html" class="btn btn-md btn-primary mb-2 ms-2 w-45"><i class="fe fe-shopping-cart me-2"></i>Add to Cart</a>
									...
									<div class="col-xl-3 col-lg-6 alert">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center zoom">
													<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/2.jpg")}}"  alt="img" ></a>
												</div>
												<div class="card-body px-0 pb-3">
													<div class="row">
														<div class="col-10">
									...
									<div class="col-xl-3 col-lg-6 alert">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center zoom">
													<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/3.jpg")}}"  alt="img" ></a>
												</div>
												<div class="card-body px-0 pb-3">
													<div class="row">
														<div class="col-10">
									...
									<div class="col-xl-3 col-lg-6 alert">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center zoom">
													<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/4.jpg")}}"  alt="img" ></a>
												</div>
												<div class="card-body px-0 pb-3">
													<div class="row">
														<div class="col-10">
									...
									<div class="col-xl-3 col-lg-6 alert">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center zoom">
													<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/5.jpg")}}"  alt="img" ></a>
												</div>
												<div class="card-body px-0 pb-3">
													<div class="row">
														<div class="col-10">
									...
									<div class="col-xl-3 col-lg-6 alert">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center zoom">
												<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/06.jpg")}}"  alt="img" ></a>
												</div>
												<div class="card-body px-0 pb-3">
													<div class="row">
														<div class="col-10">
									...
									<div class="col-xl-3 col-lg-6 alert">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center zoom">
													<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/9.jpg")}}"  alt="img" ></a>
												</div>
												<div class="card-body px-0 pb-3">
													<div class="row">
														<div class="col-10">
									...
									<div class="col-xl-3 col-lg-6 alert">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center zoom">
													<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/8.jpg")}}"  alt="img" ></a>
												</div>
												<div class="card-body px-0 pb-3">
													<div class="row">
														<div class="col-10">
									...
									<div class="col-xl-3 col-lg-6 alert">
										<div class="card item-card">
											<div class="card-body pb-0">
												<div class="text-center zoom">
													<a href="shop.html"><img class="w-100 br-5" src="{{url("assets/img/ecommerce/07.jpg")}}"  alt="img" ></a>
												</div>
												<div class="card-body px-0 pb-3">
													<div class="row">
														<div class="col-10">
