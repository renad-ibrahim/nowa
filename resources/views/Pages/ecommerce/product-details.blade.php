															...
															<ul class="carousel-item active">
																<li data-bs-target="#Slider" data-bs-slide-to="0"
																	class="thumb active my-2"><img
																		src="{{url('assets/img/ecommerce/shirt-1.png')}}"
																		alt="img"></li>
																<li data-bs-target="#Slider" data-bs-slide-to="1"
																	class="thumb my-2"><img
																		src="{{url('assets/img/ecommerce/shirt-3.png')}}"
																		alt="img"></li>
																<li data-bs-target="#Slider" data-bs-slide-to="2"
																	class="thumb my-2"><img
																		src="{{url('assets/img/ecommerce/shirt-4.png')}}"
																		alt="img"></li>
																<li data-bs-target="#Slider" data-bs-slide-to="3"
																	class="thumb my-2"><img
																		src="{{url('assets/img/ecommerce/shirt-2.png')}}"
																		alt="img"></li>
															</ul>
														</div>
													</div>
													...
													<div id="Slider" class="carousel slide" data-bs-ride="false">
														<div class="carousel-inner">
															<div class="carousel-item active"><img
																	src="{{url('assets/img/ecommerce/shirt-1.png')}}" alt="img"
																	class="img-fluid mx-auto d-block">
																<div class="text-center mt-5 mb-5 btn-list">
																</div>
															</div>
															<div class="carousel-item"> <img
																	src="{{url('assets/img/ecommerce/shirt-3.png')}}" alt="img"
																	class="img-fluid mx-auto d-block">
																<div class="text-center mb-5 mt-5 btn-list">
																</div>
															</div>
															<div class="carousel-item"> <img
																	src="{{url('assets/img/ecommerce/shirt-4.png')}}" alt="img"
																	class="img-fluid mx-auto d-block">
																<div class="text-center  mb-5 mt-5 btn-list">
																</div>
															</div>
															<div class="carousel-item"> <img
																	src="{{url('assets/img/ecommerce/shirt-2.png')}}" alt="img"
																	class="img-fluid mx-auto d-block">
																<div class="text-center  mb-5 mt-5 btn-list">
																</div>
															</div>
								...
								<div class="media mt-0 p-3 border-bottom border-top">
									<div class="d-flex me-3">
										<a href="javascript:void(0);"><img
												...
												src="{{url('assets/img/faces/6.jpg')}}"> </a>
									</div>
				...
				<div class="row">
						...
						<div class="card item-card">
							<div class="card-body pb-0 h-100  product-grid6">
								<div class="text-center product-image">
									<img src="{{url('assets/img/ecommerce/01.jpg')}}" alt="img" class="img-fluid">
								</div>
							...
							<div class="text-center border-top pt-3 pb-3 ps-2 pe-2 ">
								...
								<a href="product-cart.html" class="btn btn-secondary mb-0 mb-lg-2"><i
					...
					<div class="col-lg-3">
						<div class="card item-card">
							<div class="card-body pb-0 h-100  product-grid6">
								<div class="text-center product-image">
									<img src="{{url('assets/img/ecommerce/08.jpg')}}" alt="img" class="img-fluid">
								</div>
								<div class="card-body cardbody relative">
									<div class="cardtitle">
					...
					<div class="col-lg-3">
						<div class="card item-card">
							<div class="card-body pb-0 h-100 product-grid6">
								<div class="text-center product-image">
									<img src="{{url('assets/img/ecommerce/07.jpg')}}" alt="img" class="img-fluid">
								</div>
								<div class="card-body cardbody relative ">
									<div class="cardtitle">
										<span class="h6 font-weight-bold text-uppercase">Fashion</span>
					...
					<div class="col-lg-3">
						<div class="card item-card">
							<div class="card-body pb-0 h-100  product-grid6">
								<div class="text-center product-image">
									<img src="{{url('assets/img/ecommerce/5.jpg')}}" alt="img" class="img-fluid">
								</div>
								<div class="card-body cardbody relative">
									<div class="cardtitle">
