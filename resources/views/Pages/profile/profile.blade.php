							...
							<div class="card custom-card">
								<div class="card-body d-md-flex">
									<div class="pos-relative">
										<span class="profile-image"><img class="br-5" alt=""
												src="{{url('assets/img/faces/profile.jpg')}}"></span>
										<div class="bg-success text-white wd-1 ht-1 rounded-pill profile-online"></div>
									</div>
														...
														<div class="col-12">
															<div class="card mg-b-20 border">
																	...
																	<div class="media">
																		<div class="media-user me-2">
																			<div class="main-img-user avatar-md"><img alt=""
																					...
																					src="{{url('assets/img/faces/6.jpg')}}"></div>
																		</div>
																...
																<div class="card-body">
																	...
																	<div class="row row-sm">
																		<div class="col">
																			<a href="gallery.html"><img alt="img" class="wd-200 br-5 mb-2 mt-2 me-4"
																				src="{{url('assets/img/media/1.jpg')}}"></a>
																			<a href="gallery.html"><img alt="img" class="wd-200 br-5"
																				src="{{url('assets/img/media/2.jpg')}}"></a>
																		</div>
																	</div>
																			...
																			<div class="demo-avatar-group">
																				<div
																					...
																					<div class="main-img-user"><img alt=""
																							class="rounded-circle"
																							src="{{url('assets/img/faces/12.jpg')}}">
																					</div>
																					<div class="main-img-user"><img alt=""
																							class="rounded-circle"
																							src="{{url('assets/img/faces/12.jpg')}}">
																					...
																					<div class="main-img-user online"><img
																							...
																							src="{{url('assets/img/faces/5.jpg')}}">
																					</div>
																					<div class="main-img-user"><img alt=""
																							class="rounded-circle"
																							src="{{url('assets/img/faces/6.jpg')}}">
																					</div>
															...
															<div class="card mg-b-20 border">
																...
																<div class="card-body h-100">
																	...
																	<div class="row row-sm">
																		<div class="col">
																			<a href="gallery.html"><img alt="img" class="wd-200 br-5 mb-2 mt-2 me-4"
																				src="{{url('assets/img/media/4.jpg')}}"></a>
																			<a href="gallery.html"><img alt="img" class="wd-200 br-5 mb-2 mt-2"
																				src="{{url('assets/img/media/1.jpg')}}"></a>
																		</div>
																	</div>
																	<div class="media mg-t-15 profile-footer">
																		<div class="media-user me-2">
																			<div class="demo-avatar-group">
																				<div
																					...
																					<div class="main-img-user online"><img
																							alt="" class="rounded-circle"
																							src="{{url('assets/img/faces/7.jpg')}}">
																					</div>
																					<div class="main-img-user online"><img
																							alt="" class="rounded-circle"
																							src="{{url('assets/img/faces/5.jpg')}}">
																		...
																		<div class="media-user me-2">
																			<div class="demo-avatar-group">
																				<div
																					...
																					<div class="main-img-user"><img alt=""
																							class="rounded-circle"
																							src="{{url('assets/img/faces/3.jpg')}}">
																					</div>
																					<div class="main-img-user"><img alt=""
																							class="rounded-circle"
																							src="{{url('assets/img/faces/4.jpg')}}">
																					</div>
																					<div class="main-img-user online"><img
																							alt="" class="rounded-circle"
																							src="{{url('assets/img/faces/10.jpg')}}">
																					</div>
																					<div class="main-avatar"> +23 </div>
																				</div>
																				<!-- demo-avatar-group -->
															...
															<div class="card border">
																<div class="card-header p-4">
																	<div class="media">
																		<div class="media-user me-2">
																			<div class="main-img-user avatar-md"><img alt=""
																					class="rounded-circle"
																					src="{{url('assets/img/faces/2.jpg')}}"></div>
																		</div>
																		<div class="media-body">
																			<h6 class="mb-0 ms-2 mg-t-3">Mintrona Pechon
																				Pechon</h6><span class="text-muted ms-2">Sep
																...
																<div class="card-body h-100">
																	...
																	<div class="row row-sm">
																		<div class="col">
																			<a href="gallery.html"><img alt="img" class="wd-200 br-5 mb-2 mt-2 me-3"
																				src="{{url('assets/img/media/4.jpg')}}"></a>
																			<a href="gallery.html"><img alt="img" class="wd-200 br-5 mb-2 mt-2"
																				src="{{url('assets/img/media/3.jpg')}}"></a>
																		</div>
																	</div>
																	<div class="media mg-t-15 profile-footer">
																		<div class="media-user me-2">
																			<div class="demo-avatar-group">
																				<div
																					...
																					<div class="main-img-user online"><img
																							alt="" class="rounded-circle"
																							src="{{url('assets/img/faces/11.jpg')}}">
																					</div>
																					<div class="main-img-user"><img alt=""
																							class="rounded-circle"
																							src="{{url('assets/img/faces/12.jpg')}}">
										...
										<div class="card-body border">
											<div class="masonry row">
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/1.jpg')}}" class="js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/2.jpg')}}" class="js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/3.jpg')}}" class="js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/4.jpg')}}" class="js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/5.jpg')}}" class="js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/6.jpg')}}" class=" js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/7.jpg')}}" class=" js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/8.jpg')}}" class=" js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/9.jpg')}}" class=" js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/10.jpg')}}" class=" js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/11.jpg')}}" class=" js-img-viewer"
												...
												<div class="col-xl-3 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="{{url('assets/img/photos/12.jpg')}}" class=" js-img-viewer"
															data-caption="IMAGE-11" data-id=" rhino">
														...
														<div class="card-body  user-lock text-center">
															...
															<a href="profile.html">
																<img alt="avatar" class="rounded-circle"
																	src="{{url('')}}assets/img/faces/1.jpg">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body  user-lock text-center">
															...
															<a href="profile.html">
																<img alt="avatar" class="rounded-circle"
																	src="{{url('assets/img/faces/8.jpg')}}">
												...
												<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
													<div class="card custom-card border">
														<div class="card-body  user-lock text-center">
															...
															<a href="profile.html">
																<img alt="avatar" class="rounded-circle"
																	src="{{url('assets/img/faces/2.jpg')}}">
