				...
				<div class="main-container container-fluid">
                    ...
                    <div class="container">
						...
						<div class="row mb-5 br-5">
							<p><img src="{{url('assets/img/photos/aboutmain.jpg')}}" class="br-5"  alt="image"></p>
						</div>
                        ...
                        <div class="row mb-5">
                                ...
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{url('assets/img/faces/1.jpg')}}" alt="image">
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{url('assets/img/faces/2.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Mclaren mcannen
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{url('assets/img/faces/3.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Shimpa Craig
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card p-3">
                                    <div class="card-body">
                                        <div class="mb-3 text-center about-team">
                                            <img class="rounded-pill" src="{{url('assets/img/faces/4.jpg')}}" alt="image">
                                        </div>
                                        <div class="tx-16 text-center font-weight-semibold">
                                            Limo Peter
                                        </div>
