								...
								<div class="card-body">
									...
									<nav class="nav main-nav-column">
											<div class="main-contact-item ps-0">
												<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/2.jpg')}}"></div>
												<div class="main-contact-body">
													<h6>Abigail Johnson</h6><span class="phone">+1-234-567-890</span>
												</div>
											</div>
											<div class="main-contact-item ps-0">
												<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/1.jpg')}}"></div>
												<div class="main-contact-body">
													<h6>Cherry Blossom</h6><span class="phone">+1-644-767-890</span>
												</div>
											</div>
											<div class="main-contact-item ps-0">
												<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/12.jpg')}}"></div>
												<div class="main-contact-body">
													<h6>Liz Erd</h6><span class="phone">+1-634-577-890</span>
												</div>
											</div>
											<div class="main-contact-item ps-0">
												<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/11.jpg')}}"></div>
												<div class="main-contact-body">
													<h6>Colin Sik</h6><span class="phone">+1-834-367-890</span>
												</div>
											</div>
											<div class="main-contact-item ps-0">
												<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/4.jpg')}}"></div>
												<div class="main-contact-body">
													<h6>Rita Book</h6><span class="phone">+1-233-867-830</span>
												</div>
											</div>
											<div class="main-contact-item ps-0">
												<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/5.jpg')}}"></div>
												<div class="main-contact-body">
								...
								<div class="main-content-body main-content-body-mail card-body">
									...
									<div class="main-mail-list bd-t-0">
										<div class="main-mail-item unread">
											...
											<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/5.jpg')}}"></div>
										...
										<div class="main-mail-item unread">
											...
											<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/2.jpg')}}"></div>
											<div class="main-mail-body">
												<div class="main-mail-from">
													Albert Ansing
												</div>
										...
										<div class="main-mail-item">
											...
											<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/14.jpg')}}"></div>
											<div class="main-mail-body">
												<div class="main-mail-from">
													Marianne Audrey
												</div>
										...
										<div class="main-mail-item border-bottom-0">
											...
											<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/1.jpg')}}"></div>
											<div class="main-mail-body">
												<div class="main-mail-from">
													Jove Guden
												</div>
