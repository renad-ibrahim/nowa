												...
												<div class="main-chat-list" id="ChatList">
													<div class="media new">
														<div class="main-img-user online">
															<img alt="" src="{{url('assets/img/faces/5.jpg')}}"> <span>2</span>
														</div>
													...
													<div class="media new">
														<div class="main-img-user">
															<img alt="" src="{{url('assets/img/faces/6.jpg')}}"> <span>1</span>
														</div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media selected">
														<div class="main-img-user online"><img alt="" src="{{url('assets/img/faces/9.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/11.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/4.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media new">
														<div class="main-img-user">
															<img alt="" src="{{url('assets/img/faces/7.jpg')}}"> <span>1</span>
														</div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/8.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/12.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/15.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/10.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/3.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/7.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
													...
													<div class="media border-bottom-0">
														<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/6.jpg')}}"></div>
														<div class="media-body">
															<div class="media-contact-name">
										...
										<div class="main-content-app">
											...
											<div class="main-content-body main-content-body-chat">
												<div class="main-chat-header">
													<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/9.jpg')}}"></div>
													...
													<div class="content-inner">
														...
														<div class="media flex-row-reverse">
															...
															<div class="media-body">
																...
																<div class="main-msg-wrapper pd-0"><img alt="" class="wd-100 ht-100 br-5" src="{{url('assets/img/ecommerce/6.jpg')}}"></div>
																<div>
														...
														<div class="media">
															<div class="main-img-user online"><img alt="" src="{{url('assets/img/faces/6.jpg')}}"></div>
															<div class="media-body">
											...
											<div class="card-body p-0 chat-main">
												...
												<div class="text-center border-bottom chat-image p-4 pb-0 mb-4 br-5 mt-3">
													<div class="main-img-user avatar-xl main-avatar online mb-3 mx-auto">
														<a class="" href="profile.html"><img alt="avatar" class="rounded-circle" src="{{url('assets/img/faces/2.jpg')}}"></a>
													</div>
													<a href="profile.html"><h5 class="mb-1">Ryan Gracie</h5></a>
