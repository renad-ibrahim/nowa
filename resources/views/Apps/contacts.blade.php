											...
											<div class="main-contacts-list" id="mainContactList">
												...
												<div class="main-contact-item selected">
													...
													<div class="main-contact-star">
														<a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fe fe-more-vertical  tx-18" data-bs-toggle="tooltip" title="" data-bs-original-title="View more"></i></a>
												...
												<div class="main-contact-item">
													<div class="main-img-user"><img alt="avatar" src="{{url('assets/img/faces/3.jpg')}}"></div>
													<div class="main-contact-body">
												...
												<div class="main-contact-item">
													<div class="main-img-user"><img alt="avatar" src="{{url('assets/img/faces/4.jpg')}}"></div>
													<div class="main-contact-body">
												...
												<div class="main-contact-item">
													<div class="main-img-user"><img alt="avatar" src="{{url('assets/img/faces/6.jpg')}}"></div>
													<div class="main-contact-body">
												...
												<div class="main-contact-item">
													<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/7.jpg')}}"></div>
													<div class="main-contact-body">
												...
												<div class="main-contact-item">
													<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/8.jpg')}}"></div>
													<div class="main-contact-body">
												...
												<div class="main-contact-item">
													<div class="main-img-user online"><img alt="avatar" src="{{url('assets/img/faces/9.jpg')}}"></div>
													<div class="main-contact-body">
												...
												<div class="main-contact-item">
													<div class="main-img-user"><img alt="avatar" src="{{url('assets/img/faces/10.jpg')}}"></div>
													<div class="main-contact-body">
									...
									<div class="main-contact-info-header pt-3">
										<div class="media">
											<div class="main-img-user">
												<img alt="avatar" src="{{url('assets/img/faces/6.jpg')}}"> <a href=""><i class="fe fe-camera"></i></a>
											</div>
