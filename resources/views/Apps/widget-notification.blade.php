				...
				<!-- /breadcrumb -->
					...
					<div class="row row-sm">
						<div class="col-lg-6 col-md-6 col-xl-4">
							<div class="card mg-b-20 text-center">
								<div class="card-body h-100">
									<img src="{{url('assets/img/svgicons/no-data.svg')}}" alt="" class="wd-35p">
						...
						<div class="col-lg-6 col-md-6 col-xl-4">
							<div class="card mg-b-20 text-center">
								<div class="card-body h-100">
									<img src="{{url('assets/img/svgicons/note_taking.svg')}}" alt="" class="wd-35p">
						...
						<div class="col-lg-6 col-md-12 col-xl-4">
							<div class="card mg-b-20 text-center">
								<div class="card-body h-100">
									<img src="{{url('assets/img/svgicons/imac.svg')}}" alt="" class="wd-40p">
