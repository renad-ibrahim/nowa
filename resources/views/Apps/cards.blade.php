			...
			<div class="main-content app-content">
				...
				<div class="main-container container-fluid">
					...
					<div class="row row-sm">
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card">
								<img alt="Image" class="img-fluid card-img-top" src="{{url('assets/img/photos/14.jpg')}}">
								<div class="card-body ">
						...
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-md-t-0">
							<div class="card ">
								<img alt="Image" class="img-fluid card-img-top" src="{{url('assets/img/photos/12.jpg')}}">
								<div class="card-body ">
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
								</div>
							</div>
						...
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-md-t-0">
							<div class="card">
								<img alt="Image" class="img-fluid card-img-top" src="{{url('assets/img/photos/13.jpg')}}">
								<div class="card-body ">
									<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
								</div>
							</div>
					...
					<div class="row row-sm">
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							...
							<div class="card-body ">
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div><img alt="Image" class="img-fluid card-img-bottom bd-ts-0 bd-te-0" src="{{url('assets/img/photos/1.jpg')}}"></div>
						</div><!-- col-4 -->
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-md-t-0">
							<div class="card">
							<div class="card-body ">
								<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
							</div><img alt="Image" class="img-fluid   card-img-bottom bd-ts-0 bd-te-0" src="{{url('assets/img/photos/2.jpg')}}"></div>
						</div><!-- col-4 -->
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 mg-md-t-0">
							<div class="card">
							<div class="card-body ">
					...
					<div class="row row-sm">
						<div class="col-sm-12 col-md-12 col-lg-6 col-xl-3">
							<div class="card">
								<img alt="Image" class="br-5 img-fluid card-img-top" src="{{url('assets/img/photos/3.jpg')}}">
								<div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center br-5 ">
									...
									<p class="tx-13 mg-b-0"><a class="tx-white" href="blog.html">Read more</a></p>
								</div><!-- card-img-overlay -->
							</div>
						</div>
						<div class="col-sm-12 col-md-12 col-lg-6 col-xl-3 mg mg-md-t-0">
							<div class="card">
								<img alt="Image" class="br-5 card-img img-fluid card-img-top" src="{{url('assets/img/photos/5.jpg')}}">
								<div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center  br-5">
						...
						<div class="col-sm-12 col-md-12 col-lg-6 col-xl-3 mg-md-t-0">
							<div class="card">
								<img alt="Image" class="br-5 card-img img-fluid card-img-top" src="{{url('assets/img/photos/6.jpg')}}">
								<div class="card-img-overlay pd-30 bg-black-4 d-flex flex-column justify-content-center br-5">
					...
					<div class="row row-sm">
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="{{url('assets/img/photos/7.jpg')}}" alt="">
								<div class="card-body">
									...
									<a class="btn btn-primary btn-block" href="blog.html">Read More</a>
								</div>
							 </div>
						</div>
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="{{url('assets/img/photos/8.jpg')}}" alt="">
								<div class="card-body">
									<h4 class="card-title mb-3">Card Title</h4>
									<p class="card-text">minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<a class="btn btn-primary btn-block" href="blog.html">Read More</a>
						...
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card text-center card-img-top-1">
								<img class="card-img-top w-100" src="{{url('assets/img/photos/9.jpg')}}" alt="">
								<div class="card-body">
									<h4 class="card-title mb-3">Card Title</h4>
									<p class="card-text">minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
									<a class="btn btn-primary btn-block" href="blog.html">Read More</a>
					...
					<div class="row row-sm">
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card card-aside custom-card">
								<a href="javascript:void(0);" class="card-aside-column  cover-image" data-image-src="{{url('assets/img/media/1.jpg')}}" style="background: url(&quot;{{url('')}}assets/img/media/1.jpg&quot;) center center;"></a>
								<div class="card-body">
									...
									<div class="d-flex align-items-center pt-3 mt-auto">
										<div class="main-img-user avatar-sm me-3">
											<img src="{{url('assets/img/ecommerce/3.jpg')}}" class="w-10 rounded-circle" alt="avatar-img">
										</div>
										<div>
						...
						<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
							<div class="card card-aside custom-card">
								<div class="card-body">
									...
									<div class="d-flex align-items-center pt-3 mt-auto">
										<div class="main-img-user avatar-sm me-3">
											<img src="{{url('assets/img/ecommerce/4.jpg')}}" class="w-10 rounded-circle" alt="avatar-img">
										</div>
										<div>
											<a href="" class="text-default">Alica Nestle</a>
											<small class="d-block text-muted">15 mintues ago</small>
								...
								<a href="javascript:void(0);" class="card-aside-column  cover-image" data-image-src="{{url('assets/img/ecommerce/4.jpg')}}" style="background: url(&quot;{{url('')}}assets/img/ecommerce/4.jpg&quot;) center center;"></a>
							</div>
						</div>
					</div>
					<!-- End Row -->
