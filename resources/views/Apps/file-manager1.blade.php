				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="justify-content-center mt-2">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">File Manager 1</li>
						</ol>
					</div>
				</div>
				<!-- /breadcrumb -->
								...
								<div class="row">
										...
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="{{url('assets/img/files/folder.png')}}" alt="img" class="br-7">
												</div>
									...
									<div class="col-xl-2 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="{{url('assets/img/files/file.png')}}" alt="img" class="br-7">
												</div>
									...
									<div class="col-xl-2 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="{{url('assets/img/files/word.png')}}" alt="img" class="br-7">
												</div>
										...
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon1">
													<img src="{{url('assets/img/files/doc.png')}}" alt="img" class="br-7">
												</div>
									...
									<div class="col-xl-2 col-md-4 col-sm-6">
										<div class="card p-0 ">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="{{url('assets/img/files/image.png')}}" alt="img" class="br-7">
												</div>
