...
@section('content')
			...
			<div class="main-content app-content">
				...
				<div class="breadcrumb-header justify-content-between">
					...
					<span class="main-content-title mg-b-0 mg-b-lg-1">DARGGABLE CARDS</span>
					</div>
						...
						<div class="row row-sm">
							<div class="col-xl-4 col-sm-12 col-md-6  col-lg-4">
								...
								<div class="card custom-card card-img-top-1 card-draggable">
									<img alt="Image" class="img-fluid card-img-top" src="{{url('assets/img/photos/1.jpg')}}">
									<div class="card-body">
										<p class="card-text">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
									</div>
								</div>
							...
							<div class="col-xl-4 col-sm-12 col-md-6 col-lg-4">
								...
								<div class="card custom-card card-draggable">
									...
									<img alt="Image" class="img-fluid card-img-bottom bd-ts-0 bd-te-0" src="{{url('assets/img/photos/3.jpg')}}">
								</div>
							</div>
							<div class="col-xl-4 col-sm-12 col-md-12 col-lg-4">
								...
								<div class="card custom-card card-draggable">
									<img alt="Image" class="card-img img-fluid card-img-top " src="{{url('assets/img/photos/6.jpg')}}">
