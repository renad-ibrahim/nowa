        ...
        <div class="main-container container-fluid">
            ...
            <div class="breadcrumb-header justify-content-between">
                <div class="left-content">
                  <span class="main-content-title mg-b-0 mg-b-lg-1">LAYOUTS FORMS</span>
                </div>
                <div class="justify-content-center mt-2">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Forms</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Layouts Forms</li>
                    </ol>
                </div>
            </div>
            <!-- /breadcrumb -->
                                    ...
                                    <div class="card card-body pd-20 pd-md-40 border shadow-none">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="pos-relative">
                                                ...
                                                <div class="d-flex pos-absolute t-5 r-10"><img alt="" class="wd-30 mg-r-5" src="{{url('assets/img/visa.png')}}"> <img alt="" class="wd-30" src="{{url('assets/img/mastercard.png')}}"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
