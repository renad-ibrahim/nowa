								...
								<div class="card-body">
									<div class="row">
										<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
											<div class="prime-card"><img class="img-fluid" src="{{url('assets/img/png/dashboard8.png')}}" alt=""></div>
										</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-12 col-xs-12">
										<div class="card sales-card circle-image2">
											<div class="row">
												...
												<div class="col-4">
													<div class="circle-icon bg-primary-transparent text-center align-self-center overflow-hidden">
														<i class="fe fe-dollar-sign tx-16 text-primary"></i>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-12 col-xs-12">
										<div class="card sales-card circle-image3">
											<div class="row">
												...
												<div class="col-4">
													<div class="circle-icon bg-primary-transparent text-center align-self-center overflow-hidden">
														<i class="fe fe-external-link tx-16 text-primary"></i>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-12 col-xs-12">
										<div class="card sales-card circle-image4">
											<div class="row">
												...
												<div class="col-4">
													<div class="circle-icon bg-primary-transparent text-center align-self-center overflow-hidden">
														<i class="fe fe-credit-card tx-16 text-primary"></i>
													</div>
												</div>
											</div>
										</div>
