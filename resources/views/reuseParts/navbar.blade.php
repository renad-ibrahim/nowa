			...
			<div class="main-header-left ">
				<div class="responsive-logo">
					<a href="index.html" class="header-logo">
						<img src="{{url('assets/img/brand/logo.png')}}" class="mobile-logo logo-1" alt="logo">
						<img src="{{url('assets/img/brand/logo-white.png')}}" class="mobile-logo dark-logo-1" alt="logo">
					</a>
				</div>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
						<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
								...
								<div class="dropdown-menu">
									...
									<div class="main-message-list chat-scroll">
										<a href="chat.html" class="dropdown-item d-flex border-bottom">
											<div class="  drop-img  cover-image  " data-image-src="{{url('assets/img/faces/3.jpg')}}">
										...
										<a href="chat.html" class="dropdown-item d-flex border-bottom">
											<div class="drop-img cover-image" data-image-src="{{url('assets/img/faces/2.jpg')}}">
												<span class="avatar-status bg-teal"></span>
											</div>
											<div class="wd-90p">
												<div class="d-flex">
										...
										<a href="chat.html" class="dropdown-item d-flex border-bottom">
											<div class="drop-img cover-image" data-image-src="{{url('assets/img/faces/9.jpg')}}">
												<span class="avatar-status bg-teal"></span>
											</div>
											<div class="wd-90p">
												<div class="d-flex">
										...
										<a href="chat.html" class="dropdown-item d-flex border-bottom">
											<div class="drop-img cover-image" data-image-src="{{url('assets/img/faces/12.jpg')}}">
												<span class="avatar-status bg-teal"></span>
											</div>
											<div class="wd-90p">
												<div class="d-flex">
										...
										<a href="chat.html" class="dropdown-item d-flex border-bottom">
											<div class="drop-img cover-image" data-image-src="{{url('assets/img/faces/5.jpg')}}">
												<span class="avatar-status bg-teal"></span>
											</div>
											<div class="wd-90p">
												<div class="d-flex">
							...
							<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
								<a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown"><img alt="" src="{{url('assets/img/faces/2.jpg')}}" class=""></a>
								<div class="dropdown-menu">
									<div class="menu-header-content p-3 border-bottom">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{url('assets/img/faces/2.jpg')}}" class=""></div>
	...
	<aside class="app-sidebar">
		<div class="main-sidebar-header active">
			<a class="header-logo active" href="index.html">
				<img src="{{url('assets/img/brand/logo.png')}}" class="main-logo  desktop-logo" alt="logo">
				<img src="{{url('assets/img/brand/logo-white.png')}}" class="main-logo  desktop-dark" alt="logo">
				<img src="{{url('assets/img/brand/favicon.png')}}" class="main-logo  mobile-logo" alt="logo">
				<img src="{{url('assets/img/brand/favicon-white.png')}}" class="main-logo  mobile-dark" alt="logo">
			</a>
		</div>
			...
			<ul class="side-menu">
				...
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="index1">Dashboard-2</a></li>
						<li><a class="slide-item" href="index2">Dashboard-3</a></li>
					</ul>
				</li>
				...
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="cards">Cards</a></li>
						<li><a class="slide-item" href="darggablecards">Darggablecards</a></li>
						<li><a class="slide-item" href="rangeslider">Range-slider</a></li>
						<li><a class="slide-item" href="calendar">Calendar</a></li>
						<li><a class="slide-item" href="contacts">Contacts</a></li>
						<li><a class="slide-item" href="image-compare">Image-compare</a></li>
						<li><a class="slide-item" href="notification">Notification</a></li>
						<li><a class="slide-item" href="widget-notification">Widget-notification</a></li>
						<li><a class="slide-item" href="treeview">Treeview</a></li>
						<li><a class="slide-item" href="file-manager">File-manager</a></li>
						<li><a class="slide-item" href="file-manager1">File-manager1</a></li>
						<li><a class="slide-item" href="file-details">File-details</a></li>
					</ul>
				</li>
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="alerts">Alerts</a></li>
						<li><a class="slide-item" href="avatar">Avatar</a></li>
						<li><a class="slide-item" href="breadcrumbs">Breadcrumbs</a></li>
						<li><a class="slide-item" href="buttons">Buttons</a></li>
						<li><a class="slide-item" href="badge">Badge</a></li>
						<li><a class="slide-item" href="dropdown">Dropdown</a></li>
						<li><a class="slide-item" href="thumbnails">Thumbnails</a></li>
						<li><a class="slide-item" href="list-group">List Group</a></li>
						<li><a class="slide-item" href="navigation">Navigation</a></li>
						<li><a class="slide-item" href="images">Images</a></li>
						<li><a class="slide-item" href="pagination">Pagination</a></li>
						<li><a class="slide-item" href="popover">Popover</a></li>
						<li><a class="slide-item" href="progress">Progress</a></li>
						<li><a class="slide-item" href="spinners">Spinners</a></li>
						<li><a class="slide-item" href="media-object">Media Object</a></li>
						<li><a class="slide-item" href="typography">Typography</a></li>
						<li><a class="slide-item" href="tooltip">Tooltip</a></li>
						<li><a class="slide-item" href="toast">Toast</a></li>
						<li><a class="slide-item" href="tags">Tags</a></li>
						<li><a class="slide-item" href="tabs">Tabs</a></li>
					</ul>
				</li>
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="accordion">Accordion</a></li>
						<li><a class="slide-item" href="carousel">Carousel</a></li>
						<li><a class="slide-item" href="collapse">Collapse</a></li>
						<li><a class="slide-item" href="modals">Modals</a></li>
						<li><a class="slide-item" href="timeline">Timeline</a></li>
						<li><a class="slide-item" href="sweet-alert">Sweet Alert</a></li>
						<li><a class="slide-item" href="rating">Ratings</a></li>
						<li><a class="slide-item" href="counters">Counters</a></li>
						<li><a class="slide-item" href="search">Search</a></li>
						<li><a class="slide-item" href="userlist">Userlist</a></li>
						<li><a class="slide-item" href="blog">Blog</a></li>
						<li><a class="slide-item" href="blog-details">Blog-details</a></li>
						<li><a class="slide-item" href="edit-post">Edit-post</a></li>
						<li><a class="slide-item" href="file-attached-tags">File Attachments</a></li>
					</ul>
				</li>
					...
					<ul class="slide-menu">
						...
						<li class="sub-slide">
							...
							<ul class="sub-slide-menu">
								<li><a class="sub-side-menu__item" href="signin">Sign In</a></li>
								<li><a class="sub-side-menu__item" href="signup">Sign Up</a></li>
								<li><a class="sub-side-menu__item" href="forgot-password">Forgot Password</a></li>
								<li><a class="sub-side-menu__item" href="reset-password">Reset Password</a></li>
								<li><a class="sub-side-menu__item" href="lockscreen">Lockscreen</a></li>
								<li><a class="sub-side-menu__item" href="underconstruction">UnderConstruction</a></li>
								<li><a class="sub-side-menu__item" href="404">404 Error</a></li>
								<li><a class="sub-side-menu__item" href="500">500 Error</a></li>
								<li><a class="sub-side-menu__item" href="501">501 Error</a></li>
							</ul>
						</li>
						<li class="sub-slide">
							...
							<ul class="sub-slide-menu">
								...
								<li><a class="sub-side-menu__item" href="switcher-1">Switcher-1</a></li>
							</ul>
						</li>
						<li class="sub-slide">
							...
							<ul class="sub-slide-menu">
								<li><a class="sub-side-menu__item" href="shop">Shop</a></li>
								<li><a class="sub-side-menu__item" href="product-details">Product-Details</a></li>
								<li><a class="sub-side-menu__item" href="product-cart">Cart</a></li>
								<li><a class="sub-side-menu__item" href="check-out">Check-out</a></li>
								<li><a class="sub-side-menu__item" href="wish-list">Wish-list</a></li>
							</ul>
						</li>
						<li><a class="slide-item" href="profile">Profile</a></li>
						<li><a class="slide-item" href="profile-notifications">Notifications-list</a></li>
						<li><a class="slide-item" href="aboutus">About us</a></li>
						<li><a class="slide-item" href="settings">Settings</a></li>
						<li class="sub-slide">
							...
							<ul class="sub-slide-menu">
								<li><a class="sub-side-menu__item" href="mail">Mail</a></li>
								<li><a class="sub-side-menu__item" href="mail-compose">Mail Compose</a></li>
								<li><a class="sub-side-menu__item" href="mail-read">Read-mail</a></li>
								<li><a class="sub-side-menu__item" href="mail-settings">mail-settings</a></li>
								<li><a class="sub-side-menu__item" href="chat">Chat</a></li>
							</ul>
						</li>
						<li><a class="slide-item" href="invoice">Invoice</a></li>
						<li><a class="slide-item" href="pricing">Pricing</a></li>
						<li><a class="slide-item" href="gallery">Gallery</a></li>
						<li><a class="slide-item" href="todotask">Todotask</a></li>
						<li><a class="slide-item" href="faq">Faqs</a></li>
						<li><a class="slide-item" href="empty">Empty Page</a></li>
					</ul>
				</li>
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="background">Background</a></li>
						<li><a class="slide-item" href="border">Border</a></li>
						<li><a class="slide-item" href="display">Display</a></li>
						<li><a class="slide-item" href="flex">Flex</a></li>
						<li><a class="slide-item" href="height">Height</a></li>
						<li><a class="slide-item" href="margin">Margin</a></li>
						<li><a class="slide-item" href="padding">Padding</a></li>
						<li><a class="slide-item" href="position">Position</a></li>
						<li><a class="slide-item" href="width">Width</a></li>
						<li><a class="slide-item" href="extras">Extras</a></li>
					</ul>
				</li>
				...
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="icons">Font Awesome </a></li>
						<li><a class="slide-item" href="icons2">Material Design Icons</a></li>
						<li><a class="slide-item" href="icons3">Simple Line Icons</a></li>
						<li><a class="slide-item" href="icons4">Feather Icons</a></li>
						<li><a class="slide-item" href="icons5">Ionic Icons</a></li>
						<li><a class="slide-item" href="icons6">Flag Icons</a></li>
						<li><a class="slide-item" href="icons7">Pe7 Icons</a></li>
						<li><a class="slide-item" href="icons8">Themify Icons</a></li>
						<li><a class="slide-item" href="icons9">Typicons Icons</a></li>
						<li><a class="slide-item" href="icons10">Weather Icons</a></li>
						<li><a class="slide-item" href="icons11">Material Icons</a></li>
						<li><a class="slide-item" href="icons12">Bootstrap Icons</a></li>
					</ul>
				</li>
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="chart-morris">Morris Charts</a></li>
						<li><a class="slide-item" href="chart-flot">Flot Charts</a></li>
						<li><a class="slide-item" href="chart-chartjs">ChartJS</a></li>
						<li><a class="slide-item" href="chart-echart">Echart</a></li>
						<li><a class="slide-item" href="chart-sparkline">Sparkline</a></li>
						<li><a class="slide-item" href="chart-peity">Chart-peity</a></li>
					</ul>
				</li>
				...
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="form-elements">Form Elements</a></li>
						<li><a class="slide-item" href="form-advanced">Advanced Forms</a></li>
						<li><a class="slide-item" href="form-layouts">Form Layouts</a></li>
						<li><a class="slide-item" href="form-validation">Form Validation</a></li>
						<li><a class="slide-item" href="form-wizards">Form Wizards</a></li>
						<li><a class="slide-item" href="form-editor">Form Editor</a></li>
						<li><a class="slide-item" href="form-sizes">Form-element-sizes</a></li>
					</ul>
				</li>
				<li class="slide">
				...
				<li class="slide">
					...
					<ul class="slide-menu">
						...
						<li><a class="slide-item" href="map-leaflet">Leaflet Maps</a></li>
						<li><a class="slide-item" href="map-vector">Vector Maps</a></li>
					</ul>
				</li>
			</ul>
