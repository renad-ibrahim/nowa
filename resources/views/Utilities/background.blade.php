							...
							<div class="card-body h-100">
								...
								<div class="example">
									<div class="gray-set d-flex flex-wrap">
										<div class="bg-gray-100 ht-50 lh-2 text-center me-2 p-3 br-5">.bg-gray-100</div>
							...
							<div class="card-body h-100">
								...
								<div class="d-flex flex-wrap">
									<div class="flex-1 pos-relative">
										<img alt="" class="wd-100p ht-100p object-fit-cover  br-ts-5 br-bs-5" src="{{url('assets/img/photos/5.jpg')}}">
										<div class="pos-absolute a-0 bg-white-1"></div>
									</div>
									<div class="flex-1 pos-relative">
										<img alt="" class="wd-100p ht-100p object-fit-cover" src="{{url('assets/img/photos/5.jpg')}}">
									...
									<div class="flex-1 pos-relative">
										<img alt="" class="wd-100p ht-100p object-fit-cover  br-te-5 br-be-5" src="{{url('assets/img/photos/5.jpg')}}">
