										...
										<div class="example">
											<div class="row">
												<div class="col-6 col-md-3">
													<img alt="Responsive image" class="img-thumbnail" src="{{url('assets/img/photos/9.jpg')}}">
												</div>
												<div class="col-6 col-md-3">
													<img alt="Responsive image" class="img-thumbnail" src="{{url('assets/img/photos/13.jpg')}}">
												</div>
												<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
													<img alt="Responsive image" class="img-thumbnail" src="{{url('assets/img/photos/14.jpg')}}">
												</div>
												<div class="col-6 col-md-3 mg-t-10 mg-sm-t-0">
													<img alt="Responsive image" class="img-thumbnail" src="{{url('assets/img/photos/15.jpg')}}">
												</div>
											</div>
										</div>
									</div>
							...
							<div class="card custom-card" id="aligning">
								<div class="card-body ht-100p">
									...
									<div class="text-wrap">
										<div class="example">
											<div class="clearfix">
											  <img src="{{url('assets/img/photos/10.jpg')}}" class="float-sm-left wd-100p wd-sm-200 br-5" alt="img">
											  <img src="{{url('assets/img/photos/11.jpg')}}" class="float-sm-right wd-100p wd-sm-200 mg-t-10 mg-sm-t-0 br-5" alt="img">
											</div>
										</div>
									</div>
								</div>
